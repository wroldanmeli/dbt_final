-- back compat for old kwarg name
    ...
    merge into `metrics-streams-dev`.`ProcessedData`.`BillingfacAllocationFinal` as DBT_INTERNAL_DEST
        using (-- depends_on: `metrics-streams-dev`.`TemporalData`.`final_prefacIT_nodup` 
